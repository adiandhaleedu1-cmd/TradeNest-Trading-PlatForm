...
export default function Footer() {
    return (
        <footer className="pt-5 mt-5 border-top " style={{ backgroundColor: "#fbfbfb" }}>
            <div className="container">
                <div className="row px-5 mx-5 pt-3">
                    <div className="col-md-3">
                        <img src="/media/images/logo.svg" alt="logo" style={{ width: "70%" }} />
                        <p className="text-muted mt-4 pe-3" style={{ fontSize: "0.8rem" }}>© 2010 - 2024, Zerodha Broking Ltd. All rights reserved.</p>

                        <div className="d-flex justify-content-around fs-5 pe-5 mt-4 text-muted">
                ...
                <div className="text-muted m-5" style={{ fontSize: "0.75rem" }}>
